...
int main()
{
    ...
    personnel p;//static car les employés sont deja créer dynamiquement
    ...
    //pas la peine de faire delete, les employes sont supprimés par le destructeur de la classe personnel
